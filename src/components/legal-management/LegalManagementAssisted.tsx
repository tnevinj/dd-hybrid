        ...
        <Card className="mb-6 border-2 border-blue-200">
          <CardHeader>
            <div className="flex items-center space-x-2">
              ...
              <CardTitle className="text-blue-900">AI Legal Insights</CardTitle>
            </div>
          </CardHeader>
        ...
        <Card className="border-blue-200">
          <CardContent className="p-6">
            <div className="flex items-center space-x-2 mb-2">
              <Brain className="h-5 w-5 text-blue-600" />
              <p className="text-sm text-blue-700 font-medium">AI Risk Score</p>
            </div>
      ...
      <Card>
        ...
        <CardContent>
          <div className="space-y-4">
            {[1, 2, 3].map(index => (
              <div key={index} className="p-4 border rounded-lg bg-gradient-to-r from-white to-blue-50">
                <div className="flex justify-between items-start mb-2">
                  <div>
                  ...
                  <div className="flex items-center space-x-2">
                    <Badge className="bg-blue-100 text-blue-800">AI Score: {90 + index}%</Badge>
        ...
        <CardContent className="p-6">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-blue-700">Today's impact on your legal workflow</p>
            </div>
