  ...
  <Card className="mb-6 border-2 border-blue-200">
    <CardHeader>
      <div className="flex items-center space-x-2">
        ...
        <CardTitle className="text-blue-900">AI Workspace Insights</CardTitle>
...
const SmartWorkspaceCard: React.FC<{
  ...
  return (
    <Card className="group hover:shadow-lg transition-all duration-200 border-l-4 border-l-blue-300">
        ...
        <div className="grid grid-cols-2 gap-4 mb-3">
          ...
          <div>
            ...
            {workspace.aiEfficiency && (
              <p className="text-xs text-blue-600">AI boost: +{workspace.aiEfficiency}%</p>
            )}
          </div>
        </div>
...
export function WorkspaceAssisted({
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-blue-50 p-4 md:p-6">
      ...
      <div className="flex justify-between items-center mb-6">
        <div className="relative">
          ...
          <Input
            ...
            className="pl-10 w-96 border-blue-300 focus:border-blue-500 bg-white"
          />
        </div>
      ...
      <div className="mt-6 p-4 bg-gradient-to-r from-blue-100 to-blue-100 border border-blue-200 rounded-lg">
        <div className="flex items-start space-x-3">
          ...
          <div>
            <h4 className="font-semibold text-blue-900 mb-1">AI-Assisted Workspace Management Active</h4>
