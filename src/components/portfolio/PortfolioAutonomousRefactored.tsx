/**
 * Refactored Portfolio Autonomous Component
 ...
 */
export function PortfolioAutonomousRefactored({ 
  onSwitchMode 
}: AutonomousModeProps) {
  return <PortfolioAutonomous onSwitchMode={onSwitchMode} />
}

export default PortfolioAutonomousRefactored