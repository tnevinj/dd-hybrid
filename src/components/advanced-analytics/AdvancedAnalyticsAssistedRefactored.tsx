        ...
        <Card className="border-blue-200">
          <CardContent className="p-6">
            <div className="flex items-center space-x-2 mb-2">
              ...
              <p className="text-sm text-blue-700 font-medium">AI Models</p>
            </div>
            <p className="text-3xl font-bold text-blue-900">{metrics.activeModels || 47}</p>
      ...
      <Card className="mt-6 bg-gradient-to-r from-blue-50 to-blue-50 border border-blue-200">
        <CardContent className="p-6">
          <div className="flex items-center justify-between">
            <div>
              <h3 className="text-xl font-bold text-blue-900 mb-1">AI Analytics Performance</h3>
              <p className="text-blue-700">Advanced machine learning capabilities</p>
            </div>
            <div className="grid grid-cols-3 gap-6 text-center">
              ...
              <div>
                <p className="text-3xl font-bold text-blue-600">{metrics.accuracyImprovement || 97}%</p>
