...
interface GPPortalAutonomousProps {
  data: {
    companies: GPCompany[];
...
export function GPPortalAutonomous({ data, onExecuteAction, onRequireDecision }: GPPortalAutonomousProps) {
...
export default GPPortalAutonomous;