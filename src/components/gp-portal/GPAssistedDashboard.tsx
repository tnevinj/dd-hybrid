...
interface GPAssistedDashboardProps {
  data: {
    companies: GPCompany[];
...
export function GPAssistedDashboard({ data, onViewDetails, onAcceptSuggestion }: GPAssistedDashboardProps) {
...
export default GPAssistedDashboard;