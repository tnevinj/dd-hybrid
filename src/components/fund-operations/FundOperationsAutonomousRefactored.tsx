/**
 * Refactored Fund Operations Autonomous Component
...
import { FundOperationsAutonomous } from './FundOperationsAutonomous'
 ...
 */
export function FundOperationsAutonomousRefactored({ 
  onSwitchMode 
}: AutonomousModeProps) {
  return <FundOperationsAutonomous onSwitchMode={onSwitchMode} />
}

export default FundOperationsAutonomousRefactored