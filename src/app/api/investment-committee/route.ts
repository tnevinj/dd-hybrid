...
const mockCommittees: InvestmentCommittee[] = [
  {
    ...
    committeeType: 'MAIN' as CommitteeType,
    isActive: true,
    quorumRequirement: 5,
  ...
  },
  {
    ...
    committeeType: 'FOLLOW_ON' as CommitteeType,
    isActive: true,
    quorumRequirement: 3,
...
const mockMeetings: ICMeeting[] = [
  {
    ...
    format: 'HYBRID' as MeetingFormat,
...
const mockProposals: ICProposal[] = [
  {
    ...
    proposalType: 'NEW_INVESTMENT' as ProposalType,
    ...
    ddStatus: 'COMPLETED' as DDStatus,
    ddFindings: [
    ...
    votingStatus: 'PENDING' as VotingStatus,
  ...
  },
  {
    ...
    geography: 'Europe',
    proposalType: 'FOLLOW_ON' as ProposalType,
  ...
  },
  {
    ...
    proposalType: 'EXIT' as ProposalType,
    requestedAmount: 0,
...
const mockDecisions: ICDecision[] = [
  ...
  },
  {
    id: 'decision-2',
    proposalId: 'proposal-3',
    decision: 'REJECTED' as DecisionOutcome,
    decisionDate: new Date('2024-03-18'),
    totalVotes: 6,
    approvingVotes: 1,
    rejectingVotes: 4,
